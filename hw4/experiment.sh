...
#python3 main.py q1 --exp_name lr1e-2

#python3 main.py q2 --exp_name lr1e-2

#python3 main.py q3 --exp_name lr1e-2
#ln -s $PWD/data/HalfCheetah_q3_lr1e-2 ./data/HalfCheetah_q3_layers1
#ln -s $PWD/data/HalfCheetah_q3_lr1e-2 ./data/HalfCheetah_q3_action4096
#ln -s $PWD/data/HalfCheetah_q3_lr1e-2 ./data/HalfCheetah_q3_mpc_horizon15
...
#python3 plot.py --exps HalfCheetah_q3_layers1 HalfCheetah_q3_layers2 \
...
#python3 plot.py --exps HalfCheetah_q3_action128 HalfCheetah_q3_action4096 \
...
#python3 plot.py --exps HalfCheetah_q3_horizon10 HalfCheetah_q3_horizon15 \
#HalfCheetah_q3_horizon20 --save HalfCheetah_q3_horizon
